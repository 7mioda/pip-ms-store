 ...
 */
final class Version20190714162602 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE delivery (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(255) DEFAULT NULL, adress LONGTEXT DEFAULT NULL, coordinate_x DOUBLE PRECISION NOT NULL, coordinate_y DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, validated_at DATETIME DEFAULT NULL, `order` INT DEFAULT NULL, UNIQUE INDEX UNIQ_3781EC10C6898E08 (`order`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE flash_sale (id INT AUTO_INCREMENT NOT NULL, description LONGTEXT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, begin_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE delivery ADD CONSTRAINT FK_3781EC10C6898E08 FOREIGN KEY (`order`) REFERENCES `order` (`id`)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delivery DROP FOREIGN KEY FK_3781EC10C6898E08');
