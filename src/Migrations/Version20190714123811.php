 ...
 */
final class Version20190714123811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, `like` INT DEFAULT NULL, comment INT DEFAULT NULL, content VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_5A8A6C8DAC6340B3 (`like`), INDEX IDX_5A8A6C8D9474526C (comment), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8DAC6340B3 FOREIGN KEY (`like`) REFERENCES `like` (id)');
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8D9474526C FOREIGN KEY (comment) REFERENCES comment (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8D9474526C');
        ...
        $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8DAC6340B3');
